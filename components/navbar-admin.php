        ...
        <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar"
            ...
            <div class="offcanvas-body">
                <ul class="navbar-nav justify-content-start flex-grow-1 pe-3">
                    <li class="nav-item">
                        <a href="<?php echo BASE_URL ?>Admin/Perfil-Admin/perfil-admin.html"><img src="<?php echo BASE_URL ?>img/perfil.jpg" alt="foto-perfil"
                                class="rounded-circle w-25"></a>
                    </li>
                    <li class="nav-item p-1">
                        <a class="nav-link active" aria-current="page" href="<?php echo BASE_URL ?>Admin/Perfil-Admin/perfil-admin.html">Mi Perfil</a>
                    </li>
                    <li class="nav-item p-1">
                        <a class="nav-link" href="<?php echo BASE_URL ?>Admin/Editar-Perfil/editar-perfil-admin.html">Editar Perfil</a>
                    </li>
                    <li class="nav-item p-1">
                        <a class="nav-link" href="<?php echo BASE_URL ?>Admin/gestion-usuario-admin.html">Usuarios</a>
                    </li>
                    <li class="nav-item p-1">
                        <a class="nav-link" href="<?php echo BASE_URL ?>Admin/Eventos-Admin/eventos-admin.html">Eventos</a>
                    </li>
                    <li class="nav-item p-1">
                        <a class="nav-link"
