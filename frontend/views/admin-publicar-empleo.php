...
$modalidades = $administradorController->listarModalidades();
$modalidades = $modalidades['body'];
$jornadas = $administradorController->listarJornadas();
$jornadas = $jornadas['body'];
$carreras = $administradorController->listarCarreras(); 
...
<body class="bg-inicio">
        ...
        <div class="container mt-5">
            ...
            <form class="row g-3" id="publicarForm">
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <a href="<?php echo BASE_URL ?>views/admin-visualizar-publicaciones.php">
    ...
    <script src="../scripts/admin/publicar-empleo.js"></script>
</body>
</html>
